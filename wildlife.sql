...
COPY people (id, firstname, lastname, phonenumber, address, city, state, zip, email, badge, workcontact, trainername, level) FROM stdin;
\.
...
COPY sightings (id, animalid, personid, locationid, "time", health, age, cp) FROM stdin;
\.
